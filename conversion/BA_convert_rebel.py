...
input_dir    = os.path.join(ROOT_DIR, "data_rebel", "rebel")
output_dir   = os.path.join(ROOT_DIR, "data_rebel", "re_data")
RELATIONS_JSON = os.path.join(ROOT_DIR, "embed_relations", "relations_rebel", "220_nonorig_relations.json")
